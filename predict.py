...
class Predictor:
    def __init__(self, model_path: str, scaler_path: str):
        ...
        Args:
            model_path (str): Filepath to saved ML model (.joblib or .pkl).
...
if __name__ == "__main__":
    ...
    # Load sample raw JSON data from file or string
    ...
    results = [
        {
            "user_id": user_id,
            "performance": "higher performer" if int(label) == 1 else "lower performer",
